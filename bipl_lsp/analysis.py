"""Static analysis for BIPL, the Basic Imperative Programming Language of YAS.

The concrete syntax follows languages/BIPL/cs.egl in softlang/yas and the
typing discipline follows Language/BIPL/TypeChecker.hs.  Everything the
...
inferred from its first assignment (or from how an unassigned "input"
variable is used), and boolean values arise only from comparisons and
logical operators.
"""
